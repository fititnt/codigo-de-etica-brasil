...
python -m pybadges --left-text='Total' --right-text='12' --right-color='#26A65B' > total.svg
python -m pybadges --left-text='Profissional' --right-text='9' --right-color='#1E90FF' > profissional.svg
