...
python -m pybadges --left-text='Total' --right-text='13' --right-color='#26A65B' > total.svg
python -m pybadges --left-text='Profissional' --right-text='10' --right-color='#1E90FF' > profissional.svg
